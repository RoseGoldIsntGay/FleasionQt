...
FLEASION_URL = (
    "https://raw.githubusercontent.com/CroppingFlea479/Fleasion/main/fleasion.py"
)
ASSETS_URL = (
    "https://raw.githubusercontent.com/CroppingFlea479/Fleasion/main/assets.json"
)
    ...
    while isinstance(current_level, dict):
        ...
        for key in selected_keys:
            if key in temp_level:
                ...
                print(
                    f"{RED}Key '{key}' does not exist in '{' -> '.join(path)}'. Please try again.{DEFAULT}"
                )
                valid = False
                break
...
def bloxstrap():
    ...
    if not os.path.exists(base_path):
        ...
        print(
            "All folders created successfully! Import your skyboxes into the opened folder."
        )
        os.startfile(path)
...
mod_cache_check_path = os.path.join(
    folder_path, "3dbc81ab51ae36ab1de45855c9bb2b15"
)  # 29ec14d6f908cabca7fae131487d96d8, 016a313606e2f99a85bb1a91083206fc
pf_cache_check_path = os.path.join(
    folder_path,
    (
        "7b8ca4a4ec7addd0f55179a86e49a5a1"
        if os_name == "Linux"
        else "8312aa61609257e46c873694f81caffc"
    ),
    ...
    try:
        ...
        if os.path.exists(copy_file_path):
            for file_to_delete in files_to_delete:
                ...
                print(
                    f"{BLUE}{file_to_delete} has been replaced with {file_to_replace}.{DEFAULT}"
                )
        else:
    ...
    try:
        match int(options):
                ...
                try:
                    match int(sight_option):
                        ...
                        case 2:
                            ...
                            match int(sightbackground):
                                ...
                                case 3:
                                    ...
                                    )  # clear okp-7  blue background
                                case 4:
                                    output.append(
                                        (
                                            [
                                                "30c4d2bb30b6b8c9ac7cfeec5db25a85",
                                                "7d5652167ec33ed349e569a55a398705",
                                            ],
                                ...
                                case 5:
                                    output.append(
                                        (
                                            [
                                                "a883a2373ad6931556dce946c50c3690 ",
                                                "5a2a41b0da7ec98bf25780bb3f5d071f ",
                                            ],
                                            "d625adff6a3d75081d11b3407b0b417c",
                                        )
                                    )  # remove sniper junk
                        ...
                        case 3:
                            output.append(
                                (
                                    [data["ballistics tracker"]["default"]],
                                    dlist("ballistics tracker"),
                                )
                            )
                        case _:
                            print("Invalid option")
            ...
            case 2:
                ...
                match int(arm_option):
                    case 1:
                        output.append(
                            (
                                dlist("arm models", data["arm models"][mesh_version]),
                                "5873cfba79134ecfec6658f559d8f320",
                            )
                        )
                    case 2:
                        output.append(
                            (
                                data["arm models"][mesh_version]["bare arms"],
                                "5873cfba79134ecfec6658f559d8f320",
                            )
                        )
                        if mesh_version == "v1":
                            output.append(
                                (
                                    [
                                        "f5b0bcba5570d196909a78c7a697467c",
                                        "7f828aee555e5e1161d4b39faddda970",
                                    ],
                        ...
                        if mesh_version == "v2":
                            output.append(
                                (
                                    [
                                        "2245ea538d66f8c9eb7f453aa3e421c2",
                                        "d599df8997da0b6a3e5b12ab948f648b",
                                    ],
                                    "c9672591983da8fffedb9cec7df1e521",
                                )
                            )  # c9672591983da8fffedb9cec7df1e521 needs to be updated with new hash
                    case 3:
            ...
            case 3:
                if os_name == "Linux":
                    output.append(
                        ([data["linux"]["defaults"]["sleeves"]], dlist("skins"))
                    )
                else:
                    output.append(
                        (["8813bbc8c0f7c0901fc38c1c85935fec"], dlist("skins"))
                    )  # aa33dd87fc9db92e891361e069da1849
            case 4:
                if os_name == "Linux":
                    output.append(
                        (data["linux"]["textures"], "d625adff6a3d75081d11b3407b0b417c")
                    )
                else:
                    output.append(
                        (data["textures"], "d625adff6a3d75081d11b3407b0b417c")
                    )  # no textures without downside
            case 5:
                sky_option = input(
                ...
                match int(sky_option):
                    case 1:
                        output.append(
                            (data["skyboxes"], "d625adff6a3d75081d11b3407b0b417c")
                        )  # forced default skybox
                    case 2:
                        bloxstrap()
                    case _:
                        print("Enter a Valid Option!")
            case 6:
                if os_name == "Linux":
                    output.append(
                        (
                            [dlist("gun skins", data["skins"]["pf cases"])],
                            dlist("skins"),
                        )
                    )
                else:
            ...
            case 8:
                output.append(
                    (["8194373fb18740071f5e885bab349252"], dlist("gun smoke"))
                )
            case 9:  #
                hit_option = input(
                ...
                match int(hit_option):
                    case 1:
                        output.append(
                            (["097165b476243d2095ef0a256320b06a"], dlist("hitmarker"))
                        )  # hitmarkers
                    case 2:
                        output.append(
                            (
                                ["a177d2c00abd3e550b873d76c97ad960"],
                                dlist("replacement sounds"),
                            )
                        )
                    case 3:
                        output.append(
                            (
                                data["replacement sounds"]["kill sounds"]["default"],
                                dlist("replacement sounds"),
                            )
                        )
                    case _:
            ...
            case 10:
                ...
                match int(boom_option):
                    case 1:
                        ...
                        match int(model_option):
                            case 1:
                                output.append(
                                    (
                                        data["grenades"]["rgd"]["junk"],
                                        "5873cfba79134ecfec6658f559d8f320",
                                    )
                                )
                                output.append(
                                    (
                                        [data["grenades"]["rgd"]["main"]],
                                        dlist("grenades"),
                                    )
                                )
                                output.append(
                                    (
                                        [data["grenades"]["rgd"]["texture"]],
                                        dlist("grenades"),
                                    )
                                )
                            case 2:
                                output.append(
                                    (
                                        data["grenades"]["bundle"]["junk"],
                                        "5873cfba79134ecfec6658f559d8f320",
                                    )
                                )
                                output.append(
                                    (
                                        data["grenades"]["bundle"]["main"],
                                        dlist("grenades"),
                                    )
                                )
                                output.append(
                                    (
                                        data["grenades"]["bundle"]["texture"],
                                        dlist("grenades"),
                                    )
                                )
                            case _:
                    ...
                    case 2:
                        output.append(
                            (
                                data["replacement sounds"]["explosions"]["default"],
                                dlist("replacement sounds"),
                            )
                        )
                    case 3:
                        output.append(
                            ([dlist("grenade sounds")], dlist("replacement sounds"))
                        )
                    case _:
                        print("Enter a Valid Option!")
            case 11:
                ...
                match int(misc_option):
                    case 1:
                        output.append(
                            (
                                [
                                    "07fe5c19cdd350a4922412d00d567edd",
                                    "17bb7bd20bf6e1b41214619d16698ff4",
                                    "b36ed668aea77715747e3ebadce8a439",
                                    "fbc5302726777295ae2ccd092d2748f9",
                                ],
                                "5873cfba79134ecfec6658f559d8f320",
                            )
                        )
                        output.append(
                            (
                                ["877cb2de0924e058860135f72e800aad"],
                                "9296d1de6b6a994aee0f95c1f5206b58",
                            )
                        )
                    case 2:
                        output.append(
                            (
                                ["9d1808db108b86ddaeda18968a23a804"],
                                "1689699496f4cf0e2f0fade63f68b83a",
                            )
                        )
                        output.append(
                            (
                                [
                                    "3ad4ddcb4c77ab8bdfc83cf9c0cfafa9",
                                    "edf091bb925fa87900910e501da97018",
                                    "768131a75f0d2d95e6799a0a5acd67c6",
                                    "3d92b91e96ef916b6717a53ef3f3a442",
                                    "32e321c27457289889ac0d5fa72f7d97",
                                ],
                                "5873cfba79134ecfec6658f559d8f320",
                            )
                        )
                        output.append(
                            (
                                ["160883329152d9abc5434a1b0982ec7d"],
                                "0d05028f1eaeb0b97ecd0c473b484371",
                            )
                        )
                    case 3:
                        damage_option = input(
                        ...
                        match int(damage_option):
                            case 1:
                                output.append(
                                    (
                                        ["a0542ee89ad3cc311bb3f7d23ef94fe4"],
                                        "5873cfba79134ecfec6658f559d8f320 ",
                                    )
                                )
                            case 2:
                                output.append(
                                    (
                                        ["a0542ee89ad3cc311bb3f7d23ef94fe4"],
                                        "614546fcea8e0411a1c94d669809a459",
                                    )
                                )
                    case 4:
                        output.append(
                            (
                                ["960b11e6e7d549c8b12044201025093f"],
                                "ac59980bedb36f4b240633b08b532d08",
                            )
                        )
                    case 5:
                        output.append(
                            (
                                [
                                    "7b11fe3312b0801492d3e0f8dce62043",
                                    "853395973e94bf11a1c9edb8110da786",
                                    "1a566c1fd2deac2677bfa26b357b5cf9",
                                    "134d345ef675a18d2c73cdbb5ca03394",
                                    "f191e4a1f7ff200c57229c8c65c2e763",
                                    "18957c939764efa83229b65a05ab3fa7",
                                ],
                                "5873cfba79134ecfec6658f559d8f320",
                            )
                        )
            ...
            case 12:
                ...
                match int(fizzy_option):
                    case 1:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["usp"]["remove"],
                    ...
                    case 2:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["flashlight launcher"][
                                    "remove"
                                ],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                    ...
                    case 3:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["ar2"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                    ...
                    case 4:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["gravity gun"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                            (
                                data["fizzy"][mesh_version]["gravity gun"]["replace"],
                                data["fizzy"][mesh_version]["gravity gun"][
                                    "replacement"
                                ],
                            )
                        )
                    case 5:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["spray bottle"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                            (
                                data["fizzy"][mesh_version]["spray bottle"]["replace"],
                                data["fizzy"][mesh_version]["spray bottle"][
                                    "replacement"
                                ],
                            )
                        )
                    case 6:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["tau cannon"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                            (
                                data["fizzy"][mesh_version]["tau cannon"]["replace"],
                                data["fizzy"][mesh_version]["tau cannon"][
                                    "replacement"
                                ],
                            )
                        )
                    case 7:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["stun stick"]["replace"],
                                data["fizzy"][mesh_version]["stun stick"][
                                    "replacement"
                                ],
                            )
                        )
                    case 8:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["hyperlaser"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                            (
                                data["fizzy"][mesh_version]["hyperlaser"]["replace"],
                                data["fizzy"][mesh_version]["hyperlaser"][
                                    "replacement"
                                ],
                            )
                        )
                    ...
                    case 10:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["flashlight laser"][
                                    "remove"
                                ],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                    ...
                    case 11:
                        output.append(
                            (
                                data["fizzy"][mesh_version]["railgun"]["remove"],
                                "058e54ef5ad3fb914c34a6f446a36702",
                            )
                        )
                        output.append(
                            (
                                data["fizzy"][mesh_version]["railgun"]["replace"],
                        ...
                        match int(variant_option):
                            case 1:
                                output.append(
                                    (
                                        data["fizzy"][mesh_version]["railgun"][
                                            "custom"
                                        ]["default"],
                                        data["fizzy"][mesh_version]["railgun"][
                                            "custom"
    ...
    if menu == "1":
                    ...
                    if isinstance(replacement[1], list):
                        if len(replacement[0]) == len(replacement[1]):
                            for i, replac in enumerate(replacement[0]):
                                ...
                                print(
                                    f"{BLUE}Added successfully ({replac} -> {replacement[1][i]}){DEFAULT}"
                                )
                        else:
                            print(
                                f"{RED}This replacement is not supported, changes not applied{DEFAULT}"
                            )
                            presets[new_preset] = []
                    else:
                        for replac in replacement[0]:
                            ...
                            print(
                                f"{BLUE}Added successfully ({replac} -> {replacement[1]}){DEFAULT}"
                            )
        ...
        if blockwarn == "done":
            ...
            def website_blocks():
                website_blocklist = []
                print(
                    "Enter c(num)/t(num) to block/unblock (type 'done' when finished)"
                )
                while True:
                ...
                def delete_all_in_directory(directory):
                    try:
                        if os.path.exists(directory):
                            ...
                            print(
                                f"{RED}The directory {directory} does not exist.{DEFAULT}"
                            )
                    except Exception as e:
                        print(f"{RED}Error: {e}{DEFAULT}")
